...
export default function RegisterForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-[#0d002e]/60 border border-[#a200ff33] text-[#d4bfff] rounded-xl p-8 backdrop-blur-md shadow-neon">
      <h2 className="text-3xl font-bold mb-8 text-center">Science Theatre Registration</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <label className="flex items-center space-x-2 mt-2">
          ...
          <span className="text-sm">I agree to the <a href="#" className="text-[#a200ff] underline">Terms and Conditions</a></span>
        </label>
